...
enum BrowseSectionType {
    ...
    var title: String {
        ...
        case .featuredPlaylists:
            return "Danh sách phát nổi bật"
        case .recommendedTracks:
            return "Bài hát được đề xuất"
        }
    }
}
...
class HomeViewController: UIViewController {
    ...
    private func configureCollectionView() {
        ...
        collectionView.register(
            TitleHeaderCollectionReusableViewCell.self,
            forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader,
            withReuseIdentifier: TitleHeaderCollectionReusableViewCell.identifier
        )
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        guard let header = collectionView.dequeueReusableSupplementaryView(
            ...
            withReuseIdentifier: TitleHeaderCollectionReusableViewCell.identifier,
            for: indexPath
        ) as? TitleHeaderCollectionReusableViewCell, kind == UICollectionView.elementKindSectionHeader else {
